...
struct ASMJIT_API EInstruction : public Emittable
{
  ...
  virtual void _emit(Assembler& a) ASMJIT_NOTHROW;
...
struct ASMJIT_HIDDEN CompilerIntrinsics : public CompilerCore
{
  ...
  inline void _emit(uint32_t code) ASMJIT_NOTHROW
  {
    _emitInstruction(code);
  }

  inline void _emit(uint32_t code, const Operand& o0) ASMJIT_NOTHROW
  {
    _emitInstruction(code, &o0);
  }

  inline void _emit(uint32_t code, const Operand& o0, const Operand& o1) ASMJIT_NOTHROW
  {
    _emitInstruction(code, &o0, &o1);
  }

  inline void _emit(uint32_t code, const Operand& o0, const Operand& o1, const Operand& o2) ASMJIT_NOTHROW
  {
...
//! indirectly using @c _emit() method. The @c _emit() method needs only 
...
//! ...
//!
//! c._emit(INST_MOV, var0, imm(0));
//! c._emit(INST_ADD, var0, var1);
//! c._emit(INST_SUB, var0, var1);
//! @endcode
//!
...
//! See the next example how the @c _emit() method can be used to generate
//! abstract code.
//!
//! Use case:
//!
