...
void Emittable::_emit(Assembler& a) ASMJIT_NOTHROW
{
}
...
void EComment::_emit(Assembler& a) ASMJIT_NOTHROW
{
  if (a.getLogger())
  {
...
void EData::_emit(Assembler& a) ASMJIT_NOTHROW
{
...
void EAlign::_emit(Assembler& a) ASMJIT_NOTHROW
{
  a.align(_size);
}
...
void ETarget::_emit(Assembler& a) ASMJIT_NOTHROW
{
  a.bind(_label);
}
